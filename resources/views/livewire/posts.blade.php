            ...
            <table class="table-fixed w-full">
                <thead>
                    <tr class="bg-gray-100">
                        ...
                        <th class="px-4 py-2">NumerodeCelular</th>
                        <th class="px-4 py-2">Fechadenacimiento</th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="border px-4 py-2">{{ $post->Nombres }}</td>
                        <td class="border px-4 py-2">{{ $post->Apellidos }}</td>
                        <td class="border px-4 py-2">{{ $post->Sexo }}</td>
                        <td class="border px-4 py-2">{{ $post->Direccion }}</td>
                        <td class="border px-4 py-2">{{ $post->NumerodeCelular }}</td>
                        <td class="border px-4 py-2">{{ $post->Fechadenacimiento }}</td>
                        <td class="border px-4 py-2">{{ $post->Nacionalidad }}</td>
